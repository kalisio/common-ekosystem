...
describe('repeat', () => {
  it('runs the callback immediately, then after each duration', async () => {
  ...
  it('does not run when the external signal is already aborted', async () => {
...
describe('throttle', () => {
  it('runs the leading call even at clock zero', () => {
    vi.setSystemTime(0)
    const callback = vi.fn()
