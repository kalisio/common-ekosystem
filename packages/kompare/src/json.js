...
export const json = {
  ...
  isEqual (json1, json2, options = {}) {
    asserts.all([
      { value: json1, validator: is.nonEmptyString, message: 'json1 should be a non-empty string' },
      { value: json2, validator: is.nonEmptyString, message: 'json2 should be a non-empty string' }
    ])
  ...
  isEqualFile (json, jsonFilePath, options = {}) {
    asserts.all([
      { value: json, validator: is.nonEmptyString, message: 'json should be a non-empty string' },
