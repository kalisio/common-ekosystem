...
describe('conforms.schema', () => {
  describe('arguments validation', () => {
    it('should throw if obj is null', () => {
      expect(() => conforms.schema(null, {})).toThrow()
    })

    it('should throw if obj is undefined', () => {
      expect(() => conforms.schema(undefined, {})).toThrow()
    })

    it('should throw if obj is a string', () => {
      expect(() => conforms.schema('string', {})).toThrow()
    })

    it('should throw if obj is a number', () => {
      expect(() => conforms.schema(42, {})).toThrow()
    })

    it('should throw if obj is an array', () => {
      expect(() => conforms.schema([], {})).toThrow()
    })
  ...
  describe('nested schemas', () => {
    it('should return true if a nested schema matches', () => {
    ...
    it('should return true for a deeply nested schema that matches', () => {
